    ...
    <section className="programs-section" ref={sectionRef}>
      <div className="programs-container">
        ...
        >
          ...
          <div className="programs-header-grid">
            <motion.h2 
              className="programs-headline"
              initial={{ opacity: 0, y: 20 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, delay: 0.1 }}
            >
              Programs that{" "}
              <span className="programs-headline-accent">transform</span>{" "}
              communities
            </motion.h2>
        ...
        >
          {categories.map((cat, index) => (
            <motion.button
              key={index}
              className={`programs-tab ${activeTab === index ? 'tab-active' : ''}`}
              onClick={() => setActiveTab(index)}
              ...
              >
                <div className="programs-card-image">
                  ...
                  <div className="programs-card-badge">
                    ...
                    <span className="programs-card-badge-text">{program.category}</span>
                  </div>
        ...
        >
          {[
            ...
            <motion.div 
              key={index} 
              className={`programs-stat-card stat-${stat.accent}`}
              variants={cardVariants}
              whileHover={{ y: -4 }}
            >
              <span className="programs-stat-number">{stat.number}</span>
              <span className="programs-stat-label">{stat.label}</span>
              <div className="programs-stat-line" />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="programs-banner-content">
            <h3 className="programs-banner-title">Together We Create Positive Change</h3>
            <p className="programs-banner-text">
              Through volunteers, community leaders, CSR partners, and supporters, 
              we continue to create meaningful opportunities for those who need it most.
            </p>
            <div className="programs-banner-actions">
              <a href="/programs" className="programs-banner-cta">
                <span>Explore All Programs</span>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path d="M3 9H15M15 9L10 4M15 9L10 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
              <a href="/volunteer" className="programs-banner-secondary">
                Get Involved
                <span className="programs-banner-arrow">→</span>
              </a>
            </div>
          </div>
        </motion.div>
