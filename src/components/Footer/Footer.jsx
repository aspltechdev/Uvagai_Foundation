      ...
      <div className="ftr-container">
        <div className="ftr-grid">
          ...
          <div className="ftr-col ftr-col-brand">
            ...
            >
              <div className="ftr-brand-logo-wrap">
                <img 
                  src={footerLogo} 
                  alt="Uvagai Foundation" 
                  className="ftr-brand-logo-img"
                />
              </div>
              <div>
          ...
          <div className="ftr-col ftr-col-contact">
            ...
            <div className="ftr-contact-list">
              ...
              <div className="ftr-contact-row">
                ...
                <a href="tel:+91XXXXXXXXXX" className="ftr-contact-link">+91 XXXXX XXXXX</a>
              </div>
          ...
          <div className="ftr-bottom-inner">
            <div className="ftr-bottom-left">
              ...
              <p className="ftr-credit">
                Crafted by <span className="ftr-credit-name">ASPL Tech Solutions PVT LTD</span>
              </p>
            </div>
