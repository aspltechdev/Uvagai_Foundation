    ...
    >
      ...
      >
        <div className="uvagai-cinematic-nav-inner">
          <Link to="/" className="uvagai-cinematic-logo">
          ...
          <div className="uvagai-cinematic-nav-links">
            <Link to="/our-work" className="uvagai-cinematic-nav-link">
              Our Work
              <span className="uvagai-cinematic-nav-underline" />
            </Link>
            <Link to="/stories" className="uvagai-cinematic-nav-link">
              Stories
              <span className="uvagai-cinematic-nav-underline" />
            </Link>
            <Link to="/about" className="uvagai-cinematic-nav-link">
              About
              <span className="uvagai-cinematic-nav-underline" />
            </Link>
            <Link to="/contact" className="uvagai-cinematic-nav-link">
              Contact
              <span className="uvagai-cinematic-nav-underline" />
            </Link>
