...
export default function HomeCourse() {
  ...
  // 👇 FUNCTION TO HANDLE "Learn more" NAVIGATION
  ...
  // 👇 FUNCTION TO HANDLE "View all courses" NAVIGATION
  const handleViewAll = () => {
    navigate("/course");
    window.scrollTo({ top: 0, behavior: "smooth" });
  };
      ...
      <div className="home-course-container">
        ...
        >
          {filteredCourses.map((course) => (
            <motion.article
              ...
              layout
              onClick={() => handleLearnMore(course)} // 👈 CLICK CARD NAVIGATES
        ...
        >
          <motion.button
            ...
            onClick={handleViewAll} // 👈 NAVIGATES TO /course
