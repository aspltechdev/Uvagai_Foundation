...
export default function GalleryPage() {
  ...
  const galleryItems = [
    ...
    { image: eventImg, title: "Computer Training", category: "Skill Development", description: "Basic to advanced computer skills.", accent: "red" },
    { image: empower, title: "Vocational Training", category: "Skill Development", description: "Hands-on vocational skills.", accent: "red" },
    { image: volunteer, title: "Entrepreneurship Program", category: "Skill Development", description: "Business skills for entrepreneurs.", accent: "red" },
    { image: large1, title: "Soft Skills Training", category: "Skill Development", description: "Communication and interpersonal skills.", accent: "red" },
    ...
    { image: communityImg, title: "CSR Strategy Workshop", category: "CSR", description: "Planning with corporate partners.", accent: "blue" },
    ...
    { image: environmentnew1, title: "Eco-Friendly Workshop", category: "Environment", description: "Sustainable living practices.", accent: "red" },
    ...
    { image: environmentnew1, title: "Forest Conservation", category: "Environment", description: "Protecting forest areas.", accent: "red" },
    ...
    { image: environmentnew1, title: "Green School Program", category: "Environment", description: "Eco-education in schools.", accent: "red" },
    ...
    { image: communitynew1, title: "Relief Distribution", category: "Community", description: "Emergency relief support.", accent: "green" },
    ...
    { image: childImg, title: "Sports Tournament", category: "Community", description: "Community sports events.", accent: "green" },
