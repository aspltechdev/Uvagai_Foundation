...
// Add real screenshots to /public/images/social/ and reference them below.
// If "image" is left blank or the file is missing, it falls back to the placeholder.
const posts = [
  {
    id: 1,
      ...
      <a href={post.link} target="_blank" rel="noopener noreferrer" className="igw-img-wrap">
        {hasImage ? (
          ...
          <div className="igw-placeholder">
            ...
            <span className="igw-placeholder-sub">Add image to /images/social/</span>
          </div>
        )}
        <span className="igw-badge">
          <IGBadgeWhite />
        </span>
      </a>
