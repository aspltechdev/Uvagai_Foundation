...
// Smooth infinite marquee hook
function useMarquee(totalWidth, speed = 40, direction = "left") {
  ...
  return -offset; // x value for motion.div
}
...
export default function EventsHome() {
  ...
  // Enough repeats for seamless infinite scroll
  ...
  // Measure one “set” width (original events length) for wrap point
  useEffect(() => {
    const measure = () => {
  ...
  const x1 = useMarquee(setLength1 || 1, 60, "left");
  const x2 = useMarquee(setLength2 || 1, 55, "right");
