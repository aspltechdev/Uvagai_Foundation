...
// Motion-enabled router Link so it can still use whileHover/whileTap etc.
const MotionLink = motion(Link);

// Central place to manage where nav links point.
const NAV_LINKS = [
  ...
  const slides = [
    {
      ...
      primaryLink: "/donate?cause=education",
    ...
    },
    {
      ...
      primaryLink: "/donate?cause=healthcare",
      secondaryCTA: "Our Healthcare Work",
      secondaryLink: "/programs/healthcare",
      image: hero2,
    ...
    },
    {
      ...
      primaryLink: "/donate?cause=eldercare",
      secondaryCTA: "Learn Their Stories",
      secondaryLink: "/stories/eldercare",
      image: hero3,
    ...
    },
    {
      ...
      primaryLink: "/donate?cause=community",
      secondaryCTA: "View Communities",
      secondaryLink: "/programs/community",
      image: hero5,
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                onClick={() => navigate(currentSlide.secondaryLink)}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") navigate(currentSlide.secondaryLink);
                }}
