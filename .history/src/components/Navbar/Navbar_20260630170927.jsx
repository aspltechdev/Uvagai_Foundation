...
export default function Navbar() {
  ...
  return (
    ...
    >
            ...
            <div className="navbar-logo-image-wrapper">
              ...
              <div className="navbar-logo-fallback" style={{ display: 'none' }}>
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                  ...
                  <rect width="34" height="34" rx="8" fill="url(#navLogoGrad)" />
                  <path
                    d="M10 17L15 22L24 12"
                    stroke="white"
                    strokeWidth="2.5"
      ...
      {/* Mobile Menu - plain CSS class toggle, always in DOM */}
      <div className={`navbar-mobile-menu ${menuOpen ? "navbar-mobile-menu-active" : ""}`}>
        <div className="navbar-mobile-inner">
          <nav>
            <ul className="navbar-mobile-links">
              {navItems.map((item) => (
